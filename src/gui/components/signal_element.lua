...
local function on_gui_click(event)
  ...
  if element.tags.edit_signal_quantity then
    set_quantity_dialog.show(event.player_index, uid, element.tags.edit_signal_quantity_count, utils.exclude(element.tags, "edit_signal_quantity", "edit_signal_quantity_count"))
  end
end
