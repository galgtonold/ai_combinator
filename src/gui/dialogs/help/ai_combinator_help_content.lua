...

    {
        ...
        content = {
            ...
            { type = "spacer" },
            {
                ...
                code = "Turn on green signal when steam is above 1000, red signal when below 500",
            },
            { type = "spacer" },
            {
                type = "code_example",
                title = "Resource Management:",
                code = "Output assembling-machine-1 signal when iron plates > 100 and copper plates > 50",
            },
            { type = "spacer" },
            ...
            { type = "spacer" },
            {
                ...
                code = "Calculate inserter enable signal based on buffer levels and production rate",
            },
            { type = "spacer" },
            {
                type = "code_example",
                title = "Complex Processing:",
                code = "Balance multiple assembly lines by adjusting priority signals based on inventory levels",
            },
        },
    },
