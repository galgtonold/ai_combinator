...
edit_code_help_content.sections = {
    ...
    
    {
        ...
        content = {
            ...
            {type = "spacer"},
            {type = "code_example", title = "Using persistent variables:", code = {
    ...
    
    {
        ...
        expanded = false,
        content = {
            {type = "code_pattern", title = "Timer/Clock:", code = {
            ...
            {type = "spacer"},
            {type = "code_pattern", title = "State Machine:", code = {
            ...
            {type = "spacer"},
            {type = "code_pattern", title = "Edge Detection:", code = {
    ...
    
    {
        ...
        expanded = false,
        content = {
            {type = "warning_section", title = "Code not running?", items = {
            ...
            {type = "spacer"},
            {type = "warning_section", title = "Performance issues?", items = {
